...
<head>
    ...
    <title>LazyCode - Co to jest HTML?</title>
        ...
        <section class="bg-dark2 text-light p-5 p-lg-0 pt-lg-5 text-center text-sm-start">
            <div class="container">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <div>
                        <h1>Co to jest <span style="color:rgb(19, 87, 223);">HTML</span>?</h1>
                        <h2>Podstawy i Najważniejsze Rzeczy</h2>
                        <p class="lead my-4">
                        ...
                        <div class='K2_CBox'>
                            <div class='CB_Heading'>
                                <span style="color:#000000">Przykładowy znacznik &lt;p&gt;</span>
                            ...
                            <div id='code1'>
                                <pre>{
&lt;p&gt;To jest przykładowy kod HTML.&lt;/p&gt;
}</pre>
                            </div>
                        </div>
                        <hr id="hr">
                        <a href="lesson3.php"><button class="button-65" role="button">Kolejna Lekcja</button></a>
                    </div>
                </div>
            </div>
        </section>
